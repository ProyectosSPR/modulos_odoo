...
odoo -d odoo16c -u mercadolibre_connector,mercadolibre_payments,mercadolibre_claims,mercadolibre_sales,mercadolibre_reputation --without-demo=all --xmlrpc-port=8067 --stop-after-init
