...
odoo -d odoo16c -u mercadolibre_connector,mercadolibre_payments,mercadolibre_claims,mercadolibre_sales,mercadolibre_reputation,mercadolibre_shipments,mercadolibre_messaging,mercadolibre_products,mercadolibre_label_editor,mercadolibre_billing,billing_portal,ai_agent_core,ai_chatbot_base,ai_activity_pipeline,ai_tools_odoo,ai_playground --without-demo=all --xmlrpc-port=8067 --stop-after-init
