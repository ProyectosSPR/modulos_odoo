...
//                this.$('.invoice_this_year').empty();
        ...
        onclick_toggle_two: function(ev) {
            ...
            this.onclick_net_profit_current_months_year(ev);
            this.onclick_total_income_this_month_year(ev);
            this.onclick_total_expense_this_month_year(ev);
            this.onclick_unreconcile_items_this_month_year(ev);
        },
        onclick_net_profit_current_months_year: function(f){
            var posted = false;
            var self = this;
             if ($('#toggle-two')[0].checked == true) {
                posted = "posted"
            ...
            rpc.query({
                        ...
                        if (profit_this_months) {
                            ...
                            $('#net_profit_current_months').append('<span>' + net_profit_this_months + '</span> <div class="title">Este mes</div>')
                        } else {
                            var net_profit_this_months = profit_this_months;
                            net_profit_this_months = self.format_currency(currency, net_profit_this_months);
                            $('#net_profit_current_months').empty();
                    ...
                    rpc.query({
                        ...
                        .then(function(result) {
                            ...
                            if (profit_this_year) {
                                ...
                                $('#net_profit_current_year').append('<span>' + net_profit_this_year + '</span> <div class="title">Este año</div>')
                            } else {
                                var net_profit_this_year = profit_this_year;
                                net_profit_this_year = self.format_currency(currency, net_profit_this_year);
                                $('#net_profit_current_year').empty();
        ...
        onclick_total_income_this_month_year: function(f){
            var posted = false;
            var self = this;
             if ($('#toggle-two')[0].checked == true) {
                posted = "posted"
            ...
            rpc.query({
                ...
                .then(function(result) {
                    ...
                    if (incomes_) {
                        ...
                        $('#total_incomes_').append('<span>' + incomes_ + '</span><div class="title">Este mes</div>')
            ...
            rpc.query({
                    ...
                    .then(function(result) {
                        ...
                        if (incomes_this_year) {
                            ...
                            $('#total_incomes_this_year').append('<span>' + incomes_this_year + '</span><div class="title">Este año</div>')
                        } else {
                            incomes_this_year = -incomes_this_year;
                            incomes_this_year = self.format_currency(currency, incomes_this_year);
                            $('#total_incomes_this_year').empty();
        ...
        onclick_total_expense_this_month_year: function(f) {
            var posted = false;
            var self = this;
            if ($('#toggle-two')[0].checked == true) {
                posted = "posted"
            ...
            rpc.query({
                        ...
                        if (expense_this_month) {
                            ...
                            $('#total_expenses_').append('<span>' + expenses_this_month_ + '</span><div class="title">Este mes</div>')
                        } else {
                            var expenses_this_month_ = expense_this_month;
                            expenses_this_month_ = self.format_currency(currency, expenses_this_month_);
                            $('#total_expenses_').empty()
                    ...
                    rpc.query({
                        ...
                        if (expense_this_year) {
                            ...
                            $('#total_expense_this_year').append('<span >' + expenses_this_year_ + '</span><div class="title">Este año</div>')
                        } else {
                            var expenses_this_year_ = expense_this_year;
                            expenses_this_year_ = self.format_currency(currency, expenses_this_year_);
                            $('#total_expense_this_year').empty();
        ...
        onclick_unreconcile_items_this_month_year: function(f){
            var posted = false;
            var self = this;
             if ($('#toggle-two')[0].checked == true) {
                posted = "posted"
            ...
            rpc.query({
                ...
                .then(function(result) {
                    ...
                    $('#unreconciled_items_').append('<span>' + unreconciled_counts_ + ' Elemento(s)</span><div class="title">Este mes</div>')
                }),
            rpc.query({
                    model: "account.move",
                ...
                .then(function(result) {
                    ...
                    $('#unreconciled_counts_this_year').append('<span>' + unreconciled_counts_this_year + '  Elemento(s)</span><div class="title">Este año</div>')
                })
        },
                ...
                window.myCharts = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            {
                                label: 'Ingreso/Gasto', // Name the series
...
//            ev.preventDefault();
            ...
            rpc.query({
                ...
                $('#total_customer_invoice_current_year').append('<div" class="logo">' + '<span>' + customer_invoice_total_current_year + '</span><span>Total factura <span></div>');
                ...
                $('#total_supplier_invoice_current_year').append('<div" class="logo">' + '<span>' + supplier_invoice_total_current_year + '</span><span>Total factura<span></div>');
            })
        },
...
//            ev.preventDefault();
            ...
            rpc.query({
                ...
                $('#total_customer_invoice_current_month').append('<div" class="logo">' + '<span>' + customer_invoice_total_current_month + '</span><span>Total factura<span></div>');
                ...
                $('#total_supplier_invoice_current_month').append('<div" class="logo">' + '<span>' + supplier_invoice_total_current_month + '</span><span>Total factura<span></div>');
            })
        },
        ...
        renderElement: function(ev) {
            ...
            .then(function(ev) {
                ...
                rpc.query({
                    ...
                    $('#due_count').append('<span class="badge badge-danger">' + due_count + ' Vencimiento(s)</span>');
                })
                var f = 'this_month'
                rpc.query({
                    model: "account.move",
...
//                        $('#current_bank_balance').empty()
                ...
                rpc.query({
                    ...
                    $('#late_count').append('<span class="badge badge-danger">' + late_count + ' Atrasado(s)</span>');
                })
                rpc.query({
                    model: "account.move",
                ...
                rpc.query({
                    ...
                    if (invoice_this_month) {
                        ...
                        $('#total_invoices_').append('<span>' + total_invoices_this_month + ' ' + currency + '</span> <div class="title">Este mes</div>')
                    }
                })
                ...
                rpc.query({
                    ...
                    $('#total_invoices_last').append('<span>' + total_invoices_last_month + ' ' + currency + '</span><div class="title">Mes pasado</div>')
                })
                ...
                rpc.query({
                    ...
                    $('#unreconciled_items').append('<span>' + unreconciled_count + ' Elemento(s)</a></span> ')
                })
                rpc.query({
                    model: "account.move",
                    method: "unreconcile_items_this_month",
                ...
                .then(function(result) {
                    ...
                    $('#unreconciled_counts_this_year').empty()
                    $('#unreconciled_counts_this_year').append('<span>' + unreconciled_counts_this_year + '  Elemento(s)</span><div class="title">Este año</div>')
                    //$('#unreconciled_counts_this_year').append('<span style= "color:#455e7b;">' + unreconciled_counts_this_year + ' Elemento(s)</span><div class="title">Este año</div>')
                })
                ...
                rpc.query({
                    ...
                    $('#unreconciled_counts_last_year').append('<span>' + unreconciled_counts_last_year + '  Elemento(s)</span><div class="title">Año pasado</div>')
                })
                rpc.query({
                    model: "account.move",
                    method: "month_income"
                ...
                rpc.query({
                    ...
                    $('#total_incomes_last').append('<span>' + incomes_last + '</span><div class="title">Mes pasado</div>')
                })
                ...
                rpc.query({
                    ...
                    $('#total_incomes_last_year').append('<span>' + incomes_last_year + '</span><div class="title">Año pasado</div>')
                })
                rpc.query({
                    model: "account.move",
                    method: "month_income_this_year",
