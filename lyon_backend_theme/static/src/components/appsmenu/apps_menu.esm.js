...
patch(WebClient.prototype, "lyon_backend_theme.DefaultAppsMenu", {
    setup() {
        this._super();
...
patch(NavBar.prototype, "lyon_backend_theme.navbar", {
    getWebIconData(menu) {
        var result = "/lyon_backend_theme/static/src/img/default_icon_app.png";
        if (menu.webIconData) {
            const prefix = menu.webIconData.startsWith("P")
                ? "data:image/svg+xml;base64,"
                : "data:image/png;base64,";
...
AppsMenu.template = "lyon_backend_theme.AppsMenu";
AppsMenuSearchBar.template = "lyon_backend_theme.AppsMenuSearchResults";
