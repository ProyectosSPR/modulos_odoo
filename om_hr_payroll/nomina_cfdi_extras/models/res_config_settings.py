...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        res.update(
            ...
            vacaciones_adelantadas = params.get_param('nomina_cfdi_extras.vacaciones_adelantadas'),
        )
        return res
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param('nomina_cfdi_extras.vacaciones_adelantadas', self.vacaciones_adelantadas)
        return res
